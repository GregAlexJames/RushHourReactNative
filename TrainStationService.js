  ...
  // data taken from http://api.perthtransit.com/1/train_stations
  ...
  var getStationById = function(id){
    return trainStationList.filter(function(station) {
        return station.identifier == id;
    })[0];
  } 
  ...
  var setCrowDistance = function(lat, long){
  ...
  module.exports = {
    ...
    getTrainsForStation: getTrainsForStation,
  };
